...
import com.sunnyweather.android.logic.AppDatabase
...
object Repository {
    ...
    suspend fun addPlaceMange(placeManage: PlaceManage) : Result<Int>{
        return try {
            withContext(Dispatchers.IO){
                val queryPlaceManage = async {
                    placeManageDao.querySpecifyPlaceManage(placeManage.lng,placeManage.lat)
                }.await()
